        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-10 md:gap-12 mb-12 md:mb-16">
          ...
          <div className="col-span-2 sm:col-span-3 md:col-span-2">
            ...
            <div className="flex items-center gap-4 text-white/50 flex-wrap">
              ...
              <a href="https://github.com/arman-somani/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-purple transition-colors text-xs md:text-sm font-medium tracking-wide">
                GITHUB
              </a>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="https://github.com/arman-somani/" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors text-sm md:text-base">
                  GitHub Repository
                </a>
              </li>
            </ul>

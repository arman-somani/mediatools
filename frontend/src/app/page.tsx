  ...
  return (
    <PageWrapper>
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-6 pt-40 pb-24">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-brand-purple/10 blur-[120px] rounded-full pointer-events-none" />
        ...
        >
          ...
          <p className="text-white/60 text-xl md:text-2x2 max-w-2xl mx-auto mb-12 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-center flex-wrap">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.9 }}>
              <Link href="/converter" className="btn-primary-glow px-8 py-4 text-lg rounded-xl block">
                Convert MP4 to MP3
              </Link>
            </motion.div>
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.9 }}>
              <Link href="/youtube" className="btn-secondary px-8 py-4 text-lg rounded-xl flex items-center gap-2">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.9 }}>
              <Link href="/yt-video" className="btn-secondary px-8 py-4 text-lg rounded-xl flex items-center gap-2">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="text-red-500">
                <path d="M23.495 6.205a3.007 3.007 0 00-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 00.527 6.205a31.247 31.247 0 00-.522 5.805 31.247 31.247 0 00.522 5.783 3.007 3.007 0 002.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 002.088-2.088 31.247 31.247 0 00.5-5.783 31.247 31.247 0 00-.5-5.805zM9.609 15.601V8.408l6.264 3.602z" />
              </svg>
              YouTube to MP4
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.9 }}>
              <Link href="/universal" className="btn-secondary px-8 py-4 text-lg rounded-xl flex items-center gap-2">
      ...
      <section className="px-6 py-24">
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-3xl mx-auto glass-panel p-12 text-center relative overflow-hidden"
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center flex-wrap">
              <Link href="/converter" className="btn-primary-glow px-8 py-3 rounded-xl">
                Start Converting
              </Link>
              <Link href="/youtube" className="btn-secondary px-8 py-3 rounded-xl flex items-center gap-2 justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-red-500">
                  <path d="M23.495 6.205a3.007 3.007 0 00-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 00.527 6.205a31.247 31.247 0 00-.522 5.805 31.247 31.247 0 00.522 5.783 3.007 3.007 0 002.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 002.088-2.088 31.247 31.247 0 00.5-5.783 31.247 31.247 0 00-.5-5.805zM9.609 15.601V8.408l6.264 3.602z" />
                </svg>
                YouTube to MP3
              </Link>
              <Link href="/yt-video" className="btn-secondary px-8 py-3 rounded-xl flex items-center gap-2 justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-red-500">
                  <path d="M23.495 6.205a3.007 3.007 0 00-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 00.527 6.205a31.247 31.247 0 00-.522 5.805 31.247 31.247 0 00.522 5.783 3.007 3.007 0 002.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 002.088-2.088 31.247 31.247 0 00.5-5.783 31.247 31.247 0 00-.5-5.805zM9.609 15.601V8.408l6.264 3.602z" />
                </svg>
                YouTube to MP4
              </Link>
              <Link href="/universal" className="btn-secondary px-8 py-3 rounded-xl flex items-center gap-2 justify-center">

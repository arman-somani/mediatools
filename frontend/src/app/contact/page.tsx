            ...
            <main className="min-h-screen pt-32 px-6 pb-20 text-white relative flex justify-center">
                ...
                <div className="w-full max-w-xl relative z-10 mt-10">
                    <motion.div
                        ...
                        className="glass-panel p-10 md:p-14 rounded-3xl text-center shadow-2xl relative overflow-hidden"
                    >
                        ...
                        <div className="space-y-6 text-left">
                            <div className="flex items-center gap-5 p-5 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors group">
                                <div className="w-14 h-14 shrink-0 rounded-xl bg-brand-purple/20 flex items-center justify-center text-brand-purple group-hover:scale-110 transition-transform">
                            ...
                            <div className="flex items-center gap-5 p-5 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors group">
                                <div className="w-14 h-14 shrink-0 rounded-xl bg-emerald-500/20 flex items-center justify-center text-emerald-400 group-hover:scale-110 transition-transform">
                                    <svg width="26" height="26" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                ...
                                <div>
                                    ...
                                    <p className="text-white text-lg font-semibold flex flex-wrap gap-2">
